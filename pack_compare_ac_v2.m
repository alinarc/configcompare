...
modulekWh = [10; 20; 30; 40]; % desired module capacity range
...
nCellSer = round(moduleV./cellVmax); % # of series cells in a string with 50, 100 V
...
nModSer = ceil(packV./moduleV_actual);
...
nBalCircuits = nCellSer' .* nStringPar .* nModSer' .* nModPar; % total # balancing circuits in a pack
...
varNames2 = {'# balance circuits/pack', 'Actual pack capacity (kWh)', ...
...
title2 = 'AC pack comparisons for 50/100V, 10-40 kWh modules';
disp(title2)
disp(T2)
