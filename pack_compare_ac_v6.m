...
title1_obj = uitextarea(fig, 'Value', title1,'Position', [0 520 600 20]);
...
t2 = uitable(fig, 'Data', T2, 'Position', [0 0 600 250]);
addStyle(t2,s);
...
title2_obj  = uitextarea(fig, 'Value', title2, 'Position', [0 250 600 20]);
