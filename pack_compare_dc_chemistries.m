% This script generates a summary table comparing DC-coupled 
...
[nModPar, packkWh_actual] = get_dc_layout(modulekWh_actual, nModSer, packkWh);

packV_actual = nModSer .* moduleV_actual * 20;
